...
public class ctfNOAHReverse{
  ...
  public static void run() {
    ...
    // run thread
    calculate1 = new Thread(new ctfNOAHReverse.CalculationThread1());
    calculate1.start();
    
    calculate2 = new Thread(new ctfNOAHReverse.CalculationThread2());
    calculate2.start();
    
    calculate3 = new Thread(new ctfNOAHReverse.CalculationThread3());
    calculate3.start();
    
    calculate4 = new Thread(new ctfNOAHReverse.CalculationThread4());
    calculate4.start();
